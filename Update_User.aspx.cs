...
namespace Home_Page
{
    public partial class Update_User : System.Web.UI.Page
    {
        ...
        protected void B2_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection con2 = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\SEMESTER 3\ASP .NET\C# PROGRAMS\Home_Page\App_Data\Registration2.mdf;Integrated Security=True");
            con2.Open();
            string query2 = "UPDATE register SET pass_type = '" + T1.Text + "',nation = '" + T2.Text + "',f_name='" + T5.Text + "',l_name= '" + T6.Text + "',gender= '" + T7.Text + "',DOB='" + T8.Text + "',father='" + T9.Text + "',mother='" + T10.Text + "',city='" + T11.Text + "',country='" + T12.Text + "',religion='" + T13.Text + "',pass_no=" + T14.Text + ",place_issue='" + T15.Text + "',date_issue='" + T16.Text + "',country_issue='" + T17.Text + "',house_no=" + T18.Text + ",country_a='" + T19.Text + "',state_a='" + T20.Text + "',city_a='" + T21.Text + "',pincode=" + T22.Text + ",p_no=" + T23.Text + ",place_visit='" + T24.Text + "',duration_visa='" + T25.Text + "',no_of_entry=" + T26.Text + " WHERE eid = '" + Session["eid"] + "' ";
