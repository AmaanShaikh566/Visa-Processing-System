<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_FeedBack2.aspx.cs" Inherits="Home_Page.Admin_FeedBack2" %>
        ...
        <ul>
           ...
           <div class="D1">
               ...
               <br />
                <br />
               <center>
               <asp:GridView runat="server" Height="70%" Width="75%" AutoGenerateColumns="False" DataKeyNames="emailid" DataSourceID="SqlDataSource1" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="inquiry" HeaderText="INQUIRY" SortExpression="inquiry" />
                    </Columns>
                ...
                <headerstyle cssclass="HeaderStyle" BackColor="#800000" Font-Bold="True" ForeColor="White" />
                 <alternatingrowstyle cssclass="AlternateRowStyle" />
                   ...
                   <br />
                   <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:FeedBack %>" SelectCommand="SELECT * FROM [feedback] ORDER BY [emailid]"></asp:SqlDataSource>
